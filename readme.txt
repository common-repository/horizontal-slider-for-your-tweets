...
In WordPress:
    ...
    Go to Plugins > Add New > search for :: horizontal slider for your tweets ::
    Press Install Now for the Show notice or message on admin area plugin
    Press Activate Plugin

To install manually instead:

    Upload the horizontal-slider-for-your-tweets  directory to the /wp-content/plugins/ directory
    Activate the plugin through the Plugins menu in WordPress

	Navigate to the Settings > tweets Slider Settings .
